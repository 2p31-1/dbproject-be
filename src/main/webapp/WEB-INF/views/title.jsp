...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        ...
        <br>same occupation<br>
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <c:forEach var="movieItem" items="${occupationMovies}">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
        ...
        <br>same age<br>
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <c:forEach var="movieItem" items="${ageMovies}">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
        ...
        <br>Recommends from NettoPulikkusu<br>
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <c:forEach var="movieItem" items="${KNNMovies}">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
